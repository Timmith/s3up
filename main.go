...
var (
	...
	hashPrefixFlag      = flags.Bool("auto-content-hash-prefix", false, "Compute the md5 hash of a file's contents and use it as the path prefix")
	hashPrefixBytesFlag = flags.Uint("content-hash-bytes", 6, "Number of bytes of md5 hash to use in the path prefix. Max 16. 6 and 12 best (base64 encoding)")
